...
function writeBook(nIdx)
{
	...
	if(bLocal)
	{
		if (!isBookEmpty(nIdx))
		{
			...
			sHTML+=");return false;\" title=\""+sName+"\"><img alt=\"書本\" name=\""+getBId(nIdx)+"\" src=\""+sIcon+"\" border=0 align=\"absmiddle\">";
...
if(window.gbWhUtil&&window.gbWhVer&&window.gbWhMsg&&window.gbWhProxy)
{
	...
	goFont=new whFont("細明體","9pt","#000000","normal","normal","none");
	goHFont=new whFont("細明體","9pt","#007f00","normal","normal","underline");
